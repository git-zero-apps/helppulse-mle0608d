    ...
    <div className="bg-[#0a0a0f] text-gray-100 min-h-screen relative">
      ...
      <nav className="animate-fade-in sticky top-0 z-50 bg-[#0a0a0f]/80 backdrop-blur-xl border-b border-white/5">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <span className="text-xl font-display font-extrabold text-white">HelpPulse</span>
      ...
      <section className="relative mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        ...
        <p className="animate-fade-up [animation-delay:350ms] mt-6 text-lg text-gray-400 sm:text-xl max-w-2xl mx-auto leading-relaxed">
          Simple helpdesk and ticket management for small support teams
        </p>
      ...
      <section id="features" className="bg-[#0a0a0f] py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your customer-portal with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">agent-inbox</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your agent-inbox with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your ticket-management with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your knowledge-base with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your canned-responses with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your categories with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your customer-directory with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your internal-notes with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">satisfaction-ratings</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your satisfaction-ratings with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">reporting-dashboard</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your reporting-dashboard with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your email-integration with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your team-management with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">widget-embed</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your widget-embed with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your sla-tracking with ease using our intuitive interface.</p>
          </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">
            Join thousands of teams who use HelpPulse to work smarter.
          </p>
          <div className="mt-10">
            <Link
              href="/login"
      ...
      <footer className="border-t border-white/5 py-12">
        <div className="mx-auto max-w-6xl px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-sm text-gray-500">&copy; {new Date().getFullYear()} HelpPulse. All rights reserved.</span>
