  ...
  if (!record) {
    return (
      <div className="rounded-lg bg-red-50 border border-red-200 p-4">
        <p className="text-sm text-red-700">Category not found.</p>
      </div>
    );
  }
    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="article_count" name="article_count" type="number" className="input" defaultValue={String(record.article_count ?? "")} />
        </div>
        <div>
